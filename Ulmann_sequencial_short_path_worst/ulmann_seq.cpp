...
int main(int argc, char * argv[])
{
    ...
    // read graph file, and set parameters for the file
    int c;
    ...
    stringstream ss;
    ss << "/home/yunhong/Documents/courses/CSEG_626/graphsdb/si" << pvalue << "/rand/r" << rvalue <<"/si" << pvalue << "_r" << rvalue << "_s" << bvalue << ".A" << gvalue;
    ...
    degree_sort(A,M,1); // sort the nodes in A in descend order
    degree_sort(B,M,0); // sort the nodes in B in descend order
